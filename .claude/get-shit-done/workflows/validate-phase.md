...
```
Agent(
  prompt="Read C:/Users/victo/AppData/Local/Temp/trigr/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/victo/AppData/Local/Temp/trigr/.claude/get-shit-done/templates/VALIDATION.md`
