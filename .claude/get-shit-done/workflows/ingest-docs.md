...
```bash
INIT=$(node "C:/Users/victo/AppData/Local/Temp/trigr/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/victo/AppData/Local/Temp/trigr/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
