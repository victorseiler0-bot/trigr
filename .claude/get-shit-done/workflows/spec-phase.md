...
```bash
INIT=$(node "C:/Users/victo/AppData/Local/Temp/trigr/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/victo/AppData/Local/Temp/trigr/.claude/get-shit-done/templates/spec.md.
