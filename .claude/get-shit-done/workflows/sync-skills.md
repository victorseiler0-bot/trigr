...
INSTALL_JS_GLOBAL="C:/Users/victo/AppData/Local/Temp/trigr/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/victo/AppData/Local/Temp/trigr/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
