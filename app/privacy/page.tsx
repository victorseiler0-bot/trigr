              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2">
                    <svg className="text-blue-400 shrink-0 mt-0.5" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2.5">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={r.droit} className="p-3 bg-white/[0.02] rounded-lg border border-white/[0.04]">
                    <p className="text-blue-300 text-xs font-medium mb-1">{r.droit}</p>
                    <p className="text-zinc-400 text-xs">{r.desc}</p>
                  </div>
                ))}
              </div>
              <p className="mt-4">Pour exercer ces droits, contactez-nous à <a href="mailto:victorseiler0@gmail.com" className="text-blue-400 hover:text-blue-300">victorseiler0@gmail.com</a>. Réponse sous 30 jours.</p>
              <p className="mt-2">Vous pouvez également introduire une réclamation auprès de la <strong className="text-zinc-200">CNIL</strong> (Commission Nationale de l&apos;Informatique et des Libertés) : <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">www.cnil.fr</a></p>
            </section>
